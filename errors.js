...
module.exports = {
    ...
    exceedDailyLimitAmount: create('exceedDailyLimitAmount', Rule, 'Daily amount limit reached'),
    exceedDailyLimitCount: create('exceedDailyLimitCount', Rule, 'Daily count limit reached'),
    exceedWeeklyLimitAmount: create('exceedWeeklyLimitAmount', Rule, 'Weekly amount limit reached'),
    exceedWeeklyLimitCount: create('exceedWeeklyLimitCount', Rule, 'Weekly count limit reached'),
    exceedMonthlyLimitAmount: create('exceedMonthlyLimitAmount', Rule, 'Monthly amount limit reached'),
