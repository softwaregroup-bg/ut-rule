...
// tab split actions
export const CHANGE_SPLIT_MULTISELECT_FIELD = Symbol('CHANGE_SPLIT_MULTISELECT_FIELD');
// export const CHANGE_SPLIT_DROPDOWN_FIELD = Symbol('CHANGE_SPLIT_DROPDOWN_FIELD');
export const CHANGE_SPLIT_INPUT_FIELD = Symbol('CHANGE_SPLIT_INPUT_FIELD');
