...
BEGIN TRY
    ...
    BEGIN TRANSACTION
        ...
        BEGIN
            ...
            SELECT cai.conditionId, cai.factor, cai.name, cai.value
        ...
        -- DELETE FROM [rule].[conditionActorUnapproved] WHERE conditionId = @conditionId
        -- DELETE FROM [rule].[conditionItemUnapproved] WHERE conditionId = @conditionId
        -- DELETE FROM [rule].[conditionPropertyUnapproved] WHERE conditionId = @conditionId
        -- DELETE FROM [rule].[limitUnapproved] WHERE conditionId = @conditionId
        -- DELETE sa
        -- FROM [rule].[splitAnalyticUnapproved] sa
        -- JOIN [rule].[splitAssignmentUnapproved] sp ON sp.splitAssignmentId = sa.splitAssignmentId
        -- JOIN [rule].[splitNameUapproved] sn ON sp.splitNameId = sn.splitNameId
        -- WHERE sn.conditionId = @conditionId
        ...
        -- DELETE FROM [rule].[splitNameUnapproved] WHERE conditionId = @conditionId
