CREATE TABLE [rule].[conditionItem] (
    ...
    CONSTRAINT ccRuleConditionItem_factor CHECK (factor IN ('ss', 'ds', 'cs', 'oc', 'sc', 'dc', 'tp')) -- source spatial, destination spatial, channel spatial, operation category, source category, destination category, transaction purpose
)
