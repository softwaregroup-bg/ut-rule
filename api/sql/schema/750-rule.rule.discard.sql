...
BEGIN TRY
    ...
    BEGIN TRANSACTION
        ...
        DECLARE @splitNameId NVARCHAR(25);
    SET @splitNameId = (SELECT splitNameId FROM [rule].[splitNameUnapproved] WHERE conditionId = @conditionId )
    ...
    IF @splitNameId IS NOT NULL
        BEGIN
            ...
            WHERE sn.splitNameId = @splitNameId
