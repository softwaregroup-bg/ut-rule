CREATE TABLE [rule].[conditionActor] (
    ...
    CONSTRAINT ccRuleConditionActor_factor CHECK (factor IN ('so', 'do', 'co', 'sr', 'dr')) -- source organization, destination organization, channel organization, source role, destination role
)
